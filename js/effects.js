...
App.prototype.effects = function() {
   ...
   * Section one
   */
  scrollorama.animate('#section-one h1',{ delay: 100, duration: 500, property:'margin-top', start:(height/2) + 100,end:(height/2) + 175 });
  scrollorama.animate('#section-one h2',{ delay: 100, duration: 500, property:'margin-top', start:(height/2) + 200,end:(height/2) + 275 });
